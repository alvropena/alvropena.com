	...
	return (
		<div className="max-w-sm flex flex-col gap-4">
			...
			<p>
				...
				, a DMV permit test app that helps Gen Z study for their
				driver&apos;s exam. We&apos;ve grown to 100K+ users and
				$20k+ MRR since launching in early 2025. You can{" "}
				<Link
